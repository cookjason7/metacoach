  ...
  return (
    <div className="max-w-xl">
      <div className="bg-[#fff7ed] border border-orange-200 rounded-xl p-5 mb-6">
        <p className="text-sm font-semibold text-[#E8670A] mb-1">Hey, I'm {aiCoachName}!</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {generating ? (
            <><span className="animate-spin inline-block w-4 h-4 border-2 border-white border-t-transparent rounded-full" /> {aiCoachName} is building your program…</>
    ...
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-2">
          ✨ Generated by {aiCoachName} · Your coach can edit exercises after you save
        </p>
      </div>
...
export default function Workouts() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">AI-generated weekly programs built by {coachTitle}</p>
