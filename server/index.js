...
import { resolveViewAs, blockWritesInViewMode } from './middleware/viewAsClient.js'
...
app.use('/api/meals',      clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, mealsRouter)
app.use('/api/daily-logs', clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, dailyLogsRouter)
app.use('/api/coach',      clerkMiddleware(), blockDeactivatedClients, orgContext, coachRouter)
app.use('/api/community',       clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, communityRouter)
app.use('/api/progress-photos', clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, progressPhotosRouter)
...
app.use('/api/workouts',        clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, workoutsRouter)
app.use('/api/workout-builder',   clerkMiddleware(), blockDeactivatedClients, orgContext, workoutBuilderRouter)
app.use('/api/gamification',      clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, gamificationRouter)
...
app.use('/api/weekly-checkins',  clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, weeklyCheckinsRouter)
app.use('/api/forms',            clerkMiddleware(), blockDeactivatedClients, orgContext, formsRouter)
app.use('/api/measurements',     clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, measurementsRouter)
...
app.use('/api/fitbit',                clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, fitbitRouter)
app.use('/api/calendar',              clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, googleCalendarRouter)
app.use('/api/apple-health',          clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, appleHealthRouter)
app.use('/api/bloodwork',             clerkMiddleware(), blockDeactivatedClients, orgContext, resolveViewAs, blockWritesInViewMode, requireAssessmentComplete, bloodworkRouter)
