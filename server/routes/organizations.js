...
//
// Registered ahead of the /:id routes below — Express matches routes in
// registration order, and /:id would otherwise swallow every /mine request
// (with :id = 'mine'), hitting requireSuperAdmin and 403ing every org owner.
